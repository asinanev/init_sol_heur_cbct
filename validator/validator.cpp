/**
   This is a slightly modified version of the validator used in
   the Second International Timetabling Competition for the
   Third Track - Curriculum Based Course Timetabling.

   Changes:
			1. The main() is missing
			2. UpdateTimetable(_tt) added to Timetable class
			3. Timetable constructor changed to work without solution file

   The original file can be found here:
	https://www.eeecs.qub.ac.uk/itc2007/curriculmcourse/course_curriculm_index_files/validation.htm
*/
